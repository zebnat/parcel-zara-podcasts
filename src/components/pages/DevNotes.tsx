    ...
    <Layout>
      <div className="w-full md:w-2/3 m-auto">
        ...
        <div className="text-sm flex flex-col gap-4">
          <p>
            El desarrollo en general de la mini aplicación y los requisitos se
            ha podido realizar correctamente sin demasiados inconvenientes,
            salvo un problema con los datos de API.
          </p>
          <p>
          ...
          <p>
            ...
            oficial. Debido a eso, decidí también de pedir el Feed RSS+XML (que
            si lo devuelve) y se recorre el dom del XML para encontrarla, pero
            no es una api consistente y podría faltar la información. En ese
            caso decidí mostrar NODATA.
          </p>
          <p>
          ...
          <p>
            Los episodios se piden desde una petición adicional a ese endpoint
            de API, únicamente no he visto que venga html en la descripción que
